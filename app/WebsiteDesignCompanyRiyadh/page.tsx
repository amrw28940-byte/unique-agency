...
const portfolioItems = [
  { 
    ...
    image: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=600&q=80", // صورة تعبر عن البرمجة المتقدمة ونظام Next.js
    tag: "Next.js",
  ...
  { 
    ...
    image: "https://images.unsplash.com/photo-1488646953014-85cb44e25828?auto=format&fit=crop&w=600&q=80", // صورة تعبر عن السفر والسياحة والوجهات العالمية
    tag: "WordPress",
  ...
  { 
    ...
    image: "https://images.unsplash.com/photo-1472851294608-062f824d29cc?auto=format&fit=crop&w=600&q=80", // صورة تعبر عن التسوق الإلكتروني والمتاجر الرقمية
    tag: "E-Commerce",
  ...
  { 
    ...
    image: "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?auto=format&fit=crop&w=600&q=80", // صورة تعبر عن منتجات التجميل والعناية بالبشرة
    tag: "E-Commerce",
    link: "https://artistic-touch1.myeasyorders.com/products/Eye-Contour-Cream"
  }
];

// شريط الأخبار والكروت المتحركة المتعددة
